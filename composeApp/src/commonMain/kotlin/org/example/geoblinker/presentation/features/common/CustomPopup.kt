...
import org.example.geoblinker.presentation.features.common.EmailTextField
...
fun CustomPopup(
    ...
    var tgPhoneId by rememberSaveable { mutableStateOf(authorizationViewModel?.phone?.value ?: "") }
                                ...
                                Row(
                                    ...
                                    Switch(
                                        stateWays[index],
                                        {
                                            ...
                                            val lastPhone =
                                                prefs.getString("lastTelegramAuthPhone", "")
                                            val currentPhone = phone.filter { it.isDigit() }
                                            isTgPopup = (draggableItem.text == "Telegram")
